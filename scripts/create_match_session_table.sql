CREATE TABLE IF NOT EXISTS match_session_data (
  ...
  speed_zone_1 NUMERIC DEFAULT 0,
  speed_zone_2 NUMERIC DEFAULT 0,
  speed_zone_3 NUMERIC DEFAULT 0,
  speed_zone_4 NUMERIC DEFAULT 0,
  speed_zone_5 NUMERIC DEFAULT 0,
